package com.mad_scientists.weird_science.foundation.data.recipe;
...
public class CraftingRecipes {
    ...
    public static void recipesBlocks(Consumer<FinishedRecipe> consumer) {
        ShapedRecipeBuilder.shaped((ItemLike) AllBlocks.BENCHSTEEL_PANEL.get(), 4)
                .pattern("##")
                .pattern("##")
                ...
                .save(consumer, new ResourceLocation(ID, AllBlocks.BENCHSTEEL_PANEL.getId().getPath()));
