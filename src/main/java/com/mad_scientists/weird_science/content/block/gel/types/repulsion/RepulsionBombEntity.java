package com.mad_scientists.weird_science.content.block.gel.types.repulsion;
...
public class RepulsionBombEntity extends AbstractArrow implements ItemSupplier {
    ...
    public RepulsionBombEntity(Level level, Player player) {
        super(AllEntities.REPULSION_CAPSULE_ENTITY.get(), player, level);
        this.pickup = Pickup.DISALLOWED;
    }

    public RepulsionBombEntity(EntityType<RepulsionBombEntity> repulsionCapsuleEntityEntityType, Level level) {
        super(AllEntities.REPULSION_CAPSULE_ENTITY.get(), level);
        this.pickup = Pickup.DISALLOWED;
    }

    public RepulsionBombEntity(Level level, double x, double y, double z) {
