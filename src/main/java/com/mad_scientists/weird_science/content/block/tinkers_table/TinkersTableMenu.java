...
public class TinkersTableMenu extends AbstractContainerMenu {
    private final TinkersTableBlockEntity blockEntity;
    private final Level level;
    private final ContainerData data;

    public TinkersTableMenu(int pContainerId, Inventory inv, FriendlyByteBuf extraData) {
...
//
    ...
    public boolean stillValid(Player pPlayer) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()),
                pPlayer, AllBlocks.TINKERS_TABLE.get());
    }
