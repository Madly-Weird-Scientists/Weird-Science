...
public class PropulsionBombEntity extends AbstractArrow implements ItemSupplier {
    public PropulsionBombEntity(Level level, Player player) {
        super(AllEntities.PROPULSION_CAPSULE_ENTITY.get(), player, level);
        this.pickup = Pickup.DISALLOWED;
    }

    public PropulsionBombEntity(EntityType<PropulsionBombEntity> propulsionCapsuleEntityEntityType, Level level) {
        super(AllEntities.PROPULSION_CAPSULE_ENTITY.get(), level);
        this.pickup = Pickup.DISALLOWED;
    }

    public PropulsionBombEntity(Level level, double x, double y, double z) {
